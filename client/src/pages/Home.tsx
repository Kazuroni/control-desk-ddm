...
import {
  ...
  ChevronLeft, ChevronRight, Trophy, Users, Network, LogIn, UserX
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { id: "faltas", label: "Faltas por Carteira", icon: UserX, badge: null, color: "text-red-400" },
    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto px-6 py-4">
          ...
          {activeSection === "faltas" && <FaltasPage />}
